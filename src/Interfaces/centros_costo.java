 ...
 * @author PORTATIL
 */
public class centros_costo extends javax.swing.JInternalFrame {
...
//        fila = jTable1.getSelectedRow();
        ...
        String sql = "SELECT * FROM CENTRO_DE_COSTO where cod='" + numero + "'";
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "No ha seleccionado ninguna fila.");
        } else {
//        String sql="insert INTO CENTRO_DE_COSTO (cod,nombre) VALUES ('"+codn+"','"+jTextField1.getText().toUpperCase().trim()+"' )";
            try {
                ...
                Logger.getLogger(centros_costo.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//        inicia_todo();
    ...
    private void jBNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNuevoActionPerformed
        // TODO add your handling code here:
        String sql = "SELECT TOP 1 cast(COD as int) FROM CENTRO_DE_COSTO  ORDER BY (cast(COD as int)) DESC";
        try {
...
//        fila = jTable1.getSelectedRow();
        ...
        String sql = "DELETE FROM CENTRO_DE_COSTO WHERE cod='" + numero + "'";
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "No ha seleccionado ninguna fila.");
        } else {
//        String sql="insert INTO CENTRO_DE_COSTO (cod,nombre) VALUES ('"+codn+"','"+jTextField1.getText().toUpperCase().trim()+"' )";
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        if (v.getEditando()) {
            String sSQL = "UPDATE CENTRO_DE_COSTO SET "
                    + "nombre=?"
                    + " WHERE cod=?";
