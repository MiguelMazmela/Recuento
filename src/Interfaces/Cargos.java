...
//        fila = jTable1.getSelectedRow();
        ...
        String sql = "SELECT * FROM CARGO where cod='" + numero + "'";
        if (fila == -1) {
...
//        inicia_todo();
    ...
    private void jBNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNuevoActionPerformed
        // TODO add your handling code here:
        String sql = "SELECT TOP 1 cast(COD as int) FROM CARGO  ORDER BY (cast(COD as int)) DESC";
        try {
...
//        fila = jTable1.getSelectedRow();
        ...
        String sql = "DELETE FROM cargo WHERE cod='" + numero + "'";
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "No ha seleccionado ninguna fila.");
        } else {
//        String sql="insert INTO CARGO (cod,nombre) VALUES ('"+codn+"','"+jTextField1.getText().toUpperCase().trim()+"' )";
