 ...
 * @author PORTATIL
 */
public class CreditosXdia extends javax.swing.JInternalFrame {
...
//        int añonum = jYearChooser1.getValue();
        if (estado == ItemEvent.SELECTED) {
            filtromes = "and dfecha_documento='" + formatodeltexto.format(jDateChooser3.getDate()) + "' ";
            carga_tabla();
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        try {
            ...
            Logger.getLogger(CreditosXdia.class.getName()).log(Level.SEVERE, null, ex);
        }
